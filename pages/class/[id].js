...
export default function ClassPage() {
  ...
  const [isTeacher, setIsTeacher] = useState(null); // Null to indicate that the class is not fetched yet
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8 scroll-smooth">
      <h1 className="text-5xl font-bold mb-4 text-center">{cls.name}</h1>
      ...
      <h2 className="text-2xl font-semibold mb-4 mt-6 text-center font-mono">Posted Quizzes</h2>
      {quizzes.length > 0 ? (
